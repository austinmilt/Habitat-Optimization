...
def main():
    ...
    controlsT = ['Lamprey']
    capT = {'Fish1': 0, 'Fish2': 0, 'Fish3': 0, 'Lamprey': 42.8421}
    ...
    dbVars = {
        ...
        benefitMaxChange: database.add_parameter(benefitMaxChange, 2),
        passBase: database.add_parameter(passBase, 2),
        passChange: database.add_parameter(passChange, 2),
        ...
        costsPass: database.add_parameter(costsPass, 1),
        costsBen: database.add_parameter(costsBen, 1),
    ...
    for row in data:
        ...
        dbVars[costsPass].add_record(barrierID).value = row[cI[project2Cost[removalName]]]
        dbVars[costsBen].add_record(barrierID).value = row[cI[project2Cost[lampricideName]]]
        dbVars[benefitMaxChange].add_record((barrierID, 'Lamprey')).value = row[cI[targetMap['Lamprey'][benefitMaxChange]]]
        ...
        for t in Targets:
            ...
            dbVars[passChange].add_record((barrierID, t)).value = row[cI[targetMap[t][passChange]]]
